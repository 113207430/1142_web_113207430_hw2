...
const quizData = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: "無所謂。在浩瀚宇宙中人們的存在不過虛無飄渺，每個瞬間的行為與想法在時間洪流浩浩湯湯的奔湧之下根本不值一提。對於特定選擇的是非對錯反覆爭辯，彷彿落入漁網中以猙獰姿態翻騰的魚，無疑是徒然掙扎。既然終點終將被熵所吞沒，榮耀與羞恥、善良與卑劣、成功與失敗，也不過是生物為了抵抗虛無而臨時發明的。人類熱衷於替選擇賦予重量，彷彿只要足夠嚴肅地思考，就能讓自身短暫的存在顯得更加崇高。最終從群星的尺度回望，那些徹夜未眠的糾結，甚至不如一粒漂浮於黑暗中的宇宙塵埃更能留下痕跡。", value: 3 },
    ],
  },
  {
    title: "你的下一口會是？",
